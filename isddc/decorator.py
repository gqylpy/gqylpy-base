...
class TryExcept(BaseDecorator):
    ...
    def exception_handler(self, func_name: str, err: Exception):
        mark: str = self.mark or idc.hump(func_name)
        ...
        while True:
            try:
                ...
                try:
                    ...
                    sign: str = self.mark or idc.hump(func.__name__)
...
class RunTime(BaseDecorator):
    ...
    def core(self, func, *a, **kw):
        ...
        mark: str = self.mark or idc.hump(func.__name__)
...
class TestFuncSpeed(BaseDecorator):
    ...
    def core(self, func, *a, **kw):
        ...
        for action in min, max, idc.mean, sum:
